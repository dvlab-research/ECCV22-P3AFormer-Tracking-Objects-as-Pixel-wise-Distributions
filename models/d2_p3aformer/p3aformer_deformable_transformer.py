...
def build_deforamble_transformer(cfg):
    return DeformableTransformer(
        d_model=cfg.MODEL.DENSETRACK.HIDDEN_DIM,
        nhead=cfg.MODEL.DENSETRACK.NHEADS,
        num_encoder_layers=cfg.MODEL.DENSETRACK.ENC_LAYERS,
        num_decoder_layers=cfg.MODEL.DENSETRACK.DEC_LAYERS,
        dim_feedforward=cfg.MODEL.DENSETRACK.DIM_FEEDFORWARD,
        dropout=cfg.MODEL.DENSETRACK.DROPOUT,
        activation="relu",
        return_intermediate_dec=True,
        num_feature_levels=cfg.MODEL.DENSETRACK.NUM_FEATURE_LEVELS,
        dec_n_points=cfg.MODEL.DENSETRACK.DEC_N_POINTS,
        enc_n_points=cfg.MODEL.DENSETRACK.ENC_N_POINTS
    )
