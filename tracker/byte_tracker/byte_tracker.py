...
class BYTETracker(object):
    def __init__(self, frame_rate=30, track_thre=0.8, low_thre=0.2, first_assign_thre=0.8, second_assign_thre=0.5):
        self.tracked_stracks = []  # type: list[STrack]
        self.lost_stracks = []  # type: list[STrack]
        self.removed_stracks = []  # type: list[STrack]
        self.frame_id = 0
        self.low_thresh = low_thre
        self.track_thresh = track_thre
        self.det_thresh = self.track_thresh + 0.1
        self.first_assign_thre = first_assign_thre
        self.second_assign_thre = second_assign_thre
    ...
    def update(self, output_results):
        ...
        matches, u_track, u_detection = matching.linear_assignment(dists, thresh=self.first_assign_thre)
        ...
        matches, u_track, u_detection_second = matching.linear_assignment(dists, thresh=self.second_assign_thre)
        for itracked, idet in matches:
